...
const DatosSchema = new mongoose.Schema({
  ...
  PuntuacionMaxima: { type: Number, required: false }, // Puntuación máxima
  PuntuacionObtenida: { type: Number, required: false }, // Puntuación obtenida
  CantidadConformes: { type: Number, required: false }, // Cantidad de conformes
});
